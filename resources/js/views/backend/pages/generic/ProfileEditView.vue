  ...
  <BaseBackground image="/assets/media/photos/photo10@2x.jpg">
    <div class="bg-primary-dark-op">
      <div class="content content-full text-center">
        <div class="my-3">
          <img v-if="authUser.avatar !== ''" :src="authUser.avatar" class="img-avatar img-avatar-thumb"
            alt="User Avatar" />
        ...
        <RouterLink :to="{ name: 'backend-pages-generic-profile' }" class="btn btn-alt-secondary">
        ...
        <div class="row push">
          ...
          <div class="col-lg-8 col-xl-5">
            <div class="mb-4">
              ...
              <input type="text" class="form-control" id="one-profile-edit-name" name="one-profile-edit-name"
                placeholder="Enter your name.." v-model="detailState.name" :class="{
                  'is-invalid': vDetailRules$.name.$errors.length,
                }" @blur="vDetailRules$.name.$touch" />
              <div v-if="vDetailRules$.name.$errors.length" class="invalid-feedback animated fadeIn">
            ...
            <div class="mb-4">
              ...
              <input type="email" class="form-control" id="one-profile-edit-email" name="one-profile-edit-email"
                placeholder="Enter your email.." v-model="detailState.email" :class="{
                  'is-invalid': vDetailRules$.email.$errors.length,
                }" @blur="vDetailRules$.email.$touch" />
              <div v-if="vDetailRules$.email.$errors.length" class="invalid-feedback animated fadeIn">
                <ul style="list-style: none" class="p-0">
          ...
          <div class="col-lg-8 col-xl-5">
            <div class="mb-4">
              ...
              <input type="password" class="form-control" id="one-profile-edit-password" name="one-profile-edit-password"
                v-model="passwordState.current_password" :class="{
                  'is-invalid': vPasswordRules$.current_password.$errors.length,
                }" @blur="vPasswordRules$.current_password.$touch" />
              <div v-if="vPasswordRules$.current_password.$errors.length" class="invalid-feedback animated fadeIn">
                <ul style="list-style: none" class="p-0">
            ...
            <div class="row mb-4">
              <div class="col-12">
                ...
                <input type="password" class="form-control" id="one-profile-edit-password-new"
                  name="one-profile-edit-password-new" v-model="passwordState.password" :class="{
                    'is-invalid': vPasswordRules$.password.$errors.length
                  }" @blur="vPasswordRules$.password.$touch" />
                <div v-if="vPasswordRules$.password.$errors.length" class="invalid-feedback animated fadeIn">
                  <ul style="list-style: none" class="p-0">
            ...
            <div class="row mb-4">
              <div class="col-12">
                ...
                <input type="password" class="form-control" id="one-profile-edit-password-new-confirm"
                  name="one-profile-edit-password-new-confirm" v-model="passwordState.password_confirmation" :class="{
                    'is-invalid': vPasswordRules$.password_confirmation.$errors.length
                  }"
                  @blur="vPasswordRules$.password_confirmation.$touch" />
                <div v-if="vPasswordRules$.password_confirmation.$errors.length" class="invalid-feedback animated fadeIn">
                  <ul style="list-style: none" class="p-0">
