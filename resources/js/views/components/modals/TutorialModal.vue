      ...
      <div class="modal-content">
        <div class="block block-rounded block-transparent mb-0">
          <div class="block-header block-header-default">
            <h3 class="block-title">{{ props.title !== "" && props.title !== undefined ? `Tutorial - How to use
              the ${props.title}` : 'Tutorial' }} </h3>
            ...
            <div class="stepper">
              <ul class="nav nav-pills justify-content-center small-pills">
                <li class="nav-item" v-for="step in props.steps" :key="step.id">
                  <a class="nav-link small-pill" :class="{ active: currentStep === step.id }"
          ...
          <div class="modal-footer">
            ...
            <button v-if="currentStep === props.steps.length - 1" type="button" class="btn btn-success"
              data-bs-dismiss="modal" aria-label="Close">Let's Go!</button>
