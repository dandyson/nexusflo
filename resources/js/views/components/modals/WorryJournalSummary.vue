<template>
  <div v-if="entry">
    ...
    <div class="modal fade" :id="`modal-block-tabs-alt-worry-${modalId}`" tabindex="-1" role="dialog"
      :aria-labelledby="`modal-block-tabs-alt-worry-${modalId}`" aria-hidden="true">
          ...
          <BaseBlock transparent class="mb-0">
            <template #content>
              <ul class="nav nav-tabs nav-tabs-alt" role="tablist">
                ...
                <li class="nav-item">
                  <button type="button" class="nav-link" :id="`btabs-alt-static-balanced-thought-tab-worry-${modalId}`"
              ...
              <div class="block-content tab-content">
                <div class="tab-pane active m-3 m-lg-6" :id="`btabs-alt-static-main-worry-worry-${modalId}`"
                  role="tabpanel" :aria-labelledby="`btabs-alt-static-main-worry-tab-worry-${modalId}`" tabindex="0">
                  <p class="lead">"{{ entry.main_worry }}"</p>
                </div>
                <div class="tab-pane m-3 m-lg-1" :id="`btabs-alt-static-thinking-trap-worry-${modalId}`" role="tabpanel"
                  :aria-labelledby="`btabs-alt-static-thinking-trap-tab-worry-${modalId}`" tabindex="0">
                  <div class="content">
                ...
                <div class="tab-pane m-3 m-lg-6" :id="`btabs-alt-static-balanced-thought-worry-${modalId}`"
                  role="tabpanel" :aria-labelledby="`btabs-alt-static-balanced-thought-tab-worry-${modalId}`"
                  tabindex="0">
                  <p class="lead">"{{ entry.balanced_thought }}"</p>
                </div>
              </div>
              <div class="block-content block-content-full text-end bg-body">
                <button type="button" class="btn btn-sm btn-primary me-1" data-bs-dismiss="modal">
                  Close
                </button>
              </div>
            </template>
